...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dictionary.searchable_text'
        db.add_column(u'pleiapp_dictionary', 'searchable_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Faq.detect_automatically'
        db.add_column(u'pleiapp_faq', 'detect_automatically',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Faq.searchable_text'
        db.add_column(u'pleiapp_faq', 'searchable_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.detect_automatically'
        db.add_column(u'pleiapp_resource', 'detect_automatically',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.searchable_text'
        db.add_column(u'pleiapp_resource', 'searchable_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dictionary.searchable_text'
        db.delete_column(u'pleiapp_dictionary', 'searchable_text')

        # Deleting field 'Faq.detect_automatically'
        db.delete_column(u'pleiapp_faq', 'detect_automatically')

        # Deleting field 'Faq.searchable_text'
        db.delete_column(u'pleiapp_faq', 'searchable_text')

        # Deleting field 'Resource.detect_automatically'
        db.delete_column(u'pleiapp_resource', 'detect_automatically')

        # Deleting field 'Resource.searchable_text'
        db.delete_column(u'pleiapp_resource', 'searchable_text')
