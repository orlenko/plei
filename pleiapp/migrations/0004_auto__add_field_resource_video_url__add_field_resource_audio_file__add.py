...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.video_url'
        db.add_column(u'pleiapp_resource', 'video_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True, null=True),
                      keep_default=False)

        # Adding field 'Resource.audio_file'
        db.add_column(u'pleiapp_resource', 'audio_file',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.attached_document'
        db.add_column(u'pleiapp_resource', 'attached_document',
                      self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.video_url'
        db.delete_column(u'pleiapp_resource', 'video_url')

        # Deleting field 'Resource.audio_file'
        db.delete_column(u'pleiapp_resource', 'audio_file')

        # Deleting field 'Resource.attached_document'
        db.delete_column(u'pleiapp_resource', 'attached_document')
    ...
    models = {
        ...
        u'pleiapp.resource': {
            ...
            'video_url': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'})
        },
        u'pleiapp.tagline': {
