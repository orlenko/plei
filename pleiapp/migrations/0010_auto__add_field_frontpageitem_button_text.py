...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FrontPageItem.button_text'
        db.add_column(u'pleiapp_frontpageitem', 'button_text',
                      self.gf('django.db.models.fields.CharField')(default='Read More', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FrontPageItem.button_text'
        db.delete_column(u'pleiapp_frontpageitem', 'button_text')
    ...
    models = {
        ...
        u'pleiapp.frontpageitem': {
            ...
            'button_text': ('django.db.models.fields.CharField', [], {'default': "'Read More'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'featured_image': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
