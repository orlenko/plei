...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pleiapp_category', 'visible',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Type.visible'
        db.add_column(u'pleiapp_type', 'visible',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'pleiapp_category', 'visible')

        # Deleting field 'Type.visible'
        db.delete_column(u'pleiapp_type', 'visible')
