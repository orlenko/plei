...
// (function(win) {
	...
	// if (respond.mediaQueriesSupported) {
		// return
	// }
	// var doc = win.document, docElem = doc.documentElement, mediastyles = [], rules = [], appendedEls = [], parsedSheets = {}, resizeThrottle = 30, head = doc.getElementsByTagName("head")[0] || docElem, base = doc.getElementsByTagName("base")[0], links = head.getElementsByTagName("link"), requestQueue = [], ripCSS = function() {
		// var sheets = links, sl = sheets.length, i = 0, sheet, href, media, isCSS;
		// for (; i < sl; i++) {
	...
	// }, translate = function(styles, href, media) {
		// var qs = styles.match(/@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi), ql = qs && qs.length || 0, href = href.substring(0, href.lastIndexOf("/")), repUrls = function(css) {
...
(function(e) {
	/*var t = e(".main-nav li.current_page_item a").html();
